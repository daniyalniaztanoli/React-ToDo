  ...
  return (
    ...
    <div className='md:flex md:justify-center mx-10 mt-5 md:mx-0 md:mt-10 space-y-2 md:space-y-0 md:space-x-2'>
        <div className='flex flex-col'>
            ...
            <input type="text" value={newtitle}  onChange={(e)=>setnewtitle(e.target.value)} placeholder='Enter Your Title Task.....' className='md:py-3 md:px-10 p-1 rounded focus:outline-2 focus:outline-cyan-500' />
        </div>
        <div className='flex flex-col'>
        <label className='md:text-2xl text-white'>Description : </label>
            <input type="text" value={newdescription} onChange={(e)=>setnewdescription(e.target.value)} placeholder='Enter Your Description Task.....' className='md:py-3 md:px-10 p-1 rounded focus:outline-2 focus:outline-cyan-500'/>
        </div>
    ...
    <div className='md:my-10 w-[60%] mx-auto hidden md:block'>
    ...
    
        {
           todo.map((item,index)=>{
                return(
                    <><div className='flex justify-between mx-auto px-3 mt-4 border-b w-[80%]'>
                    <div className='w-[80%] mt-3 rounded text-white' key={index}>
                        <ul>
                            <li>
                    ...
                    </div><div className='flex space-x-2 mt-5 cursor-pointer'>
